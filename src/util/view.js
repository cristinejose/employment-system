...
export function showRow_comp() {
    ...
    for (var i = 1; i < table.rows.length; i++) {
        table.rows[i].onclick = function() {
            ...
            document.getElementById("id").value = this.cells[1].innerHTML;
            document.getElementById("month").value = this.cells[2].innerHTML;
            document.getElementById("salary").value = this.cells[3].innerHTML;
            document.getElementById("bonus").value = this.cells[4].innerHTML;
            document.getElementById("commission").value = this.cells[5].innerHTML;
